  ...
  return (
    <div className="app">
      ...
      <footer className="app-footer">
        <p>
          ClawTrad v0.1 — Paste an Irish tune. Choose a tuning. Get a
          clawhammer tab starting point.
        </p>
        <p className="footer-note">
          Output is a playable first-pass arrangement, not a definitive
          transcription. See warnings above for known limitations.
        </p>
      </footer>
    </div>
  );
